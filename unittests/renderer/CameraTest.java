...
class CameraTest {
    ...
    void testBuilder() {
        ...
        Point location1 = target1.subtract(Point.ZERO).normalize().scale(10);
        Vector vRight1 = new Vector(0, 0, 1).normalize();
        Vector vUp1 = new Vector(1, 1, 0).normalize();
        Vector direction1 = location1.add(vUp1.normalize()).subtract(vRight1).subtract(Point.ZERO);
        ...
        Point location2 = new Point(0, 10, 0);
        Vector vRight2 = new Vector(1, 0, 0).normalize();
        Vector vUp2 = new Vector(0, 0, 1).normalize();
        Vector direction2 = location2.add(vUp2).subtract(vRight2).subtract(Point.ZERO);
